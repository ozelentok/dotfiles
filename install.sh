...
dotfiles_packages=(firefox-developer-edition chromium openssh keepassx htop unrar rdesktop gimp audacity vlc smplayer deluge ntfs-3g exfat-utils fuse-exfat alsa-utils net-tools ctags mlocate python python2 python-pip python2-pip)
