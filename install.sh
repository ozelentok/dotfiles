...
dotfiles_packages=(firefox chromium openssh keepassx htop unrar gimp audacity vlc smplayer deluge ntfs-3g exfat-utils fuse-exfat alsa-utils net-tools ctags mlocatei python python2 python-pip python2-pip)
