# Generated by Powerlevel10k configuration wizard on 2024-03-29 at 19:46 IDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_VCS_DISABLED_WORKDIR_PATTERN='/bin/*|/boot/*|/dev/*|/lib/*|/lib64/*|/proc/*|/sbin/*|/sys/*|/usr/*'
