...
map('n', '<C-p>', '<cmd>Telescope find_files follow=true<CR>')
...
map('n', '<leader>s', '<cmd>Telescope search_history<CR>')
map('n', '<leader>b', '<cmd>Telescope spell_suggest initial_mode=normal<CR>')
...
map('n', '<leader>mm', '<cmd>Telescope man_pages<CR>')
