...
map('n', '<leader><leader>g', '<cmd>Git<CR>')
...
map('n', '<leader>ff', '<cmd>Telescope buffers<CR>')
map('n', '<leader>fg', '<cmd>Telescope oldfiles<CR>')
map('n', '<leader>jm', '<cmd>Telescope command_history<CR>')
map('n', '<leader>hf', '<cmd>Telescope search_history<CR>')
