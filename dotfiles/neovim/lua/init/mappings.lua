...
map_vim('n', '<C-w>l', '<cmd>HopLine<CR>')
map_vim('n', '<C-w>p', '<cmd>HopPattern<CR>')
map_vim('n', '<C-w>c', '<cmd>HopChar1<CR>')
map_vim('v', '<C-w>w', '<cmd>HopWord<CR>')
map_vim('v', '<C-w>l', '<cmd>HopLine<CR>')
